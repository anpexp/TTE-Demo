        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsImported = table.Column<int>(type: "int", nullable: false),
                    CategoriesImported = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalJobs_Users_ReviewedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBeforeDiscount = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Users_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenJtiHash = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_InventoryAvailable", "[InventoryAvailable] >= 0");
                    table.CheckConstraint("CK_Product_InventoryAvailable_LTE_Total", "[InventoryAvailable] <= [InventoryTotal]");
                    table.CheckConstraint("CK_Product_InventoryTotal", "[InventoryTotal] >= 0");
                    table.CheckConstraint("CK_Product_RatingAverage", "[RatingAverage] >= 0.0 AND [RatingAverage] <= 5.0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryNameSnapshot = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalJobs_ReviewedBy",
                table: "ApprovalJobs",
                column: "ReviewedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalJobs_Status_CreatedAt",
                table: "ApprovalJobs",
                columns: new[] { "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalJobs_Type_Status",
                table: "ApprovalJobs",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "Source", "SourceType", "SourceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExternalMappings_SourceId",
                table: "ExternalMappings",
                column: "SourceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_State",
                table: "Products",
